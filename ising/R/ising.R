...
#' \strong{isingMLE}: Find the maximum likelihood estimate in a graphical Ising model.\cr
...
#' \strong{IsingLikelihood}: Compute the likelihood of a data set from a graphical Ising model. \cr
