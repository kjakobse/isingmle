...
// For each row in eHatOmitNA, calculate the distance between the given entries of m and xi. Note that the entries in eHatOmitNA are assumed 1-indexed, so 1 is subtracted as c++ uses 0-indexing:
