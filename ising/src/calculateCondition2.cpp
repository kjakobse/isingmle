...
// For each row in e, calculate the difference between the given entries of m and xi. Note that the entries in e are assumed 1-indexed, so 1 is subtracted as c++ uses 0-indexing:
